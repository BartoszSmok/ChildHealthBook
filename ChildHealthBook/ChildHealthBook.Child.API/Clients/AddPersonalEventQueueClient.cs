...
{
    public class AddPersonalEventQueueClient : BackgroundService
    {
        ...
        public AddPersonalEventQueueClient([NotNull] IServiceProvider serviceProvider, [NotNull] IEventRepository eventRepository, IChildApiSettings apiSettings)
        {
            ...
            while (!stoppingToken.IsCancellationRequested)
            {
                try
                {
                    ...
                    if (_queueClient.Exists())
                    {
                        ...
                        {
                            await _eventRepository.AddNewPersonalEvent(item.MessageText);
